...
const (
	Profile_Create_FullMethodName = "/profile.Profile/Create"
)
...
func (c *profileClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, Profile_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedProfileServer) Create(context.Context, *CreateRequest) (*CreateResponse, error) {
